...
def register(server: FastMCP, env: ToolEnvironment) -> None:
    ...
    @server.tool(
        name="assets.page.media.list",
        structured_output=True,
        description="List media (photos/videos) for a page.",
    )
    ...
    @server.tool(
        name="assets.video.upload.init",
        structured_output=True,
        description="Initialize a resumable video upload session.",
    )
    ...
    @server.tool(
        name="assets.video.upload.chunk",
        structured_output=True,
        description="Upload a chunk of data for a video upload session.",
    )
    async def video_upload_chunk(
        args: AssetsVideoUploadChunk, ctx: Context
    ) -> Mapping[str, object]:
        try:
    ...
    @server.tool(
        name="assets.video.upload.finish",
        structured_output=True,
        description="Finish a video upload session.",
    )
    async def video_upload_finish(
        args: AssetsVideoUploadFinish, ctx: Context
    ) -> Mapping[str, object]:
        try:
            path = f"/{version}/{args.upload_session_id}"
            form = {
    ...
    @server.tool(
        name="assets.video.subtitles.upload",
        structured_output=True,
        description="Upload subtitles for a video.",
    )
    async def video_subtitles_upload(
        args: AssetsVideoSubtitlesUpload, ctx: Context
    ) -> Mapping[str, object]:
        try:
    ...
    @server.tool(
        name="ig.media.create",
        structured_output=True,
        description="Create an Instagram media container (for publishing).",
    )

...
def test_extract_meta():
    headers = {"x-app-usage": "10%", "other-header": "value", "fbtrace_id": "trace123"}
...
async def test_ensure_scopes():
    ...
    env.token_service.ensure_permissions.return_value = Mock(
        subject_id="123", type=Mock(value="page")
    )

...
async def test_connect_mock_session():
    with (
        patch("mcp_meta_sdk.client.streamablehttp_client") as mock_client,
        patch("mcp_meta_sdk.client.ClientSession") as mock_session_cls,
    ):

...
async def test_video_upload_chunk(registered_tools, ctx, respx_mock):
    ...
    args = AssetsVideoUploadChunk(upload_session_id="sess_123", start_offset=0, chunk=b"binarydata")
...
async def test_video_subtitles_upload(registered_tools, ctx, respx_mock):
    ...
    args = AssetsVideoSubtitlesUpload(
        video_id="vid_123", lang="en_US", srt_buffer=b"1\n00:00:01 -> 00:00:02\nHello"
    )
...
async def test_page_photos_create(registered_tools, ctx, respx_mock):
    ...
    args = PagePhotosCreate(page_id="page_123", url="https://site.com/img.jpg", caption="Hello")
...
async def test_page_videos_create(registered_tools, ctx, respx_mock):
    ...
    args = PageVideosCreate(page_id="page_123", url="https://site.com/vid.mp4", description="Desc")
